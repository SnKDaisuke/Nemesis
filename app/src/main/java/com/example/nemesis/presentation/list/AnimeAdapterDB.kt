...
class AnimeAdapterDB(private var dataSet: MutableList<AnimeStorage>, private var listener: ((AnimeStorage) -> Unit)? = null) : RecyclerView.Adapter<AnimeAdapterDB.ViewHolder>() {
    ...
    fun UpdateListDB(list: MutableList<AnimeStorage>){
